...
<@layout.registrationLayout displayInfo=(realm.registrationAllowed && !registrationDisabled??); section>
    ...
    <#elseif section = "form">
        ...
        <script type="module">
            import { authenticateByWebAuthn } from "keycloak/themes/grisera/login${url.resourcesPath}/js/webauthnAuthenticate.js";
            import { initAuthenticate } from "keycloak/themes/grisera/login${url.resourcesPath}/js/passkeysConditionalAuth.js";
